...
<div class="login-box">
  <div class="login-logo">
    <a href="/res/admin/index2.html"><b>Identifique-se</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">Conectar ao sistema e-commerce</p>
    ...
    <a href="register.html" class="text-center">Regsitrar novo usuario</a>
